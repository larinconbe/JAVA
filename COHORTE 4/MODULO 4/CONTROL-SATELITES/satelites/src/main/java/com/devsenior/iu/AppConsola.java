        ...
        do {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    try {
                        controlService.registrarMedicion(satId, medicion);
                ...
                case 4:
                    ...
                    try {
                        System.out.println(
                                "Historial de Mediciones: " + controlService.consultarMedicionesDeSatelite(satIdHist));
                    } catch (Exception e) {
                        System.out.println(e.getMessage()); // Manejo de excepción si el satélite no se encuentra
                    }
                    break;
                case 5:
                    ...
                    try {
                        Estado nuevoEstado = Estado.valueOf(nuevoEstadoStr.toUpperCase()); // Convertir la entrada a
                                                                                           // mayúsculas para evitar
                                                                                           // errores y con valueOf
                                                                                           // convierto el String a
                                                                                           // Estado
